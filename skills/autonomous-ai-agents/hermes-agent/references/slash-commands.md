...
/busy [queue|steer|interrupt] How messages behave while working (CLI + gateway; Slack: /hermes busy ...)
...
/busy [queue|steer|interrupt|status] Busy message handling (GW; Slack: /hermes busy ...)
